  ...
  <div>
    ...
    <div v-if="isModalOpen" class="modal-overlay">
      <div class="modal">
        ...
        <div class="mb-4">
          <label for="itemName" class="block text-sm font-medium text-gray-700"> Название </label>
          <input v-model="itemData.name" type="text" id="itemName" />
        </div>

        <div class="mb-4">
          <label for="itemPrice" class="block text-sm font-medium text-gray-700"> Цена </label>
        ...
        <div class="mb-4">
          <label for="itemWeight" class="block text-sm font-medium text-gray-700"> Вес </label>
        ...
        <div class="mb-4">
          <label for="itemKitchen" class="block text-sm font-medium text-gray-700"> Кухня </label>
        ...
        <button v-if="selectedItemId" @click="deleteItem" class="add-button red-button">
          Удалить
        </button>
    ...
    <div v-if="isAddItemModalOpen" class="modal-overlay">
      <div class="modal">
        ...
        <div class="mb-4">
          ...
          <img
            v-if="addItemData.imageUrl"
            :src="addItemData.imageUrl"
            alt="Preview"
            class="mt-2 max-h-40"
          />
        </div>
        ...
        <div class="mb-4">
          <label for="addItemPrice" class="block text-sm font-medium text-gray-700"> Цена </label>
  ...
  if (selectedItemId.value) {
    try {
      const response = await axios.delete(
        `http://185.128.106.222:3000/dish/${selectedItemId.value}`,
        {
          headers: {
            Authorization:
              'Bearer eyJhbGciOiJIUzI1NiJ9.eyJyb2xlIjowfQ.bQoM-YvgvSYMcASgpMpgI5-JtaZSDu3lzGjH2soiK3s'
